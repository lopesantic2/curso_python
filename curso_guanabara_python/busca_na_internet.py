...
def busca_na_internet(t):
  #
  # Retorna o número de pessoas que clicaram no primeiro link da busca.
  #
  # Args:
  #   t: Número de pessoas que clicaram no terceiro link da busca.
  #
  # Returns:
  #   O número de pessoas que clicaram no primeiro link da busca.
  #
